...
namespace SystemWrapper.Core
{
    ...
    public class DateTimeWrap : IDateTime
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:SystemWrapper.Core.DateTimeWrap"/> class.
        /// </summary>
        public DateTimeWrap()
        {
            Initialize();
        ...
        /// <inheritdoc />
        public IDateTime Date => new DateTimeWrap(DateTimeInstance.Date);

        /// <inheritdoc />
        public DateTime DateTimeInstance { get; private set; }

        /// <inheritdoc />
        public int Day => DateTimeInstance.Day;
        ...
        /// <inheritdoc />
        public int Hour => DateTimeInstance.Hour;

        /// <inheritdoc />
        public DateTimeKind Kind => DateTimeInstance.Kind;

        /// <inheritdoc />
        public int Millisecond => DateTimeInstance.Millisecond;

        /// <inheritdoc />
        public int Minute => DateTimeInstance.Minute;

        /// <inheritdoc />
        public int Month => DateTimeInstance.Month;

        /// <inheritdoc />
        public IDateTime Now => new DateTimeWrap(DateTime.Now);

        /// <inheritdoc />
        public int Second => DateTimeInstance.Second;

        /// <inheritdoc />
        public long Ticks => DateTimeInstance.Ticks;

        /// <inheritdoc />
        public TimeSpan TimeOfDay => DateTimeInstance.TimeOfDay;

        /// <inheritdoc />
        public IDateTime Today => new DateTimeWrap(DateTime.Today);

        /// <inheritdoc />
        public IDateTime UtcNow => new DateTimeWrap(DateTime.UtcNow);

        /// <inheritdoc />
        public int Year => DateTimeInstance.Year;
